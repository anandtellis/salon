...
const services = [
  { name: "Haircut", image: "https://placehold.co/400x400.png", hint: "salon haircut" },
  { name: "Nails", image: "https://placehold.co/400x400.png", hint: "manicure nails" },
  { name: "Bridal", image: "https://placehold.co/400x400.png", hint: "bridal makeup" },
  { name: "Skin", image: "https://placehold.co/400x400.png", hint: "facial spa" },
  { name: "Makeup", image: "https://placehold.co/400x400.png", hint: "woman makeup" },
];
...
const offers = [
  ...
  { title: "Bridal Combo @ ₹25,000", description: "Complete bridal package for your special day.", image: "https://placehold.co/600x400.png", hint: "wedding bride" },
  { title: "Flat 15% Off on Facials", description: "Get a glowing skin with our range of facials.", image: "https://placehold.co/600x400.png", hint: "woman facial" },
];

const testimonials = [
  { name: "Priya Sharma", role: "Happy Customer", avatar: "https://placehold.co/100x100.png", text: "Aura Salon is my go-to place for all things beauty. The staff is incredibly talented and professional. I always leave feeling amazing!" },
  { name: "Anjali Mehta", role: "Loyal Client", avatar: "https://placehold.co/100x100.png", text: "The bridal makeup I got done here was flawless. It lasted the whole day and I got so many compliments. Highly recommend them!" },
  { name: "Rina Das", role: "Regular Visitor", avatar: "https://placehold.co/100x100.png", text: "I love the calming atmosphere at Aura. It's a perfect escape from the city buzz. Their nail art is simply the best in town." },
  { name: "Sunita Rao", role: "New Customer", avatar: "https://placehold.co/100x100.png", text: "First time at Aura and it was a fantastic experience. The haircut was exactly what I wanted. The stylist really listened to me." },
];
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative h-[60vh] md:h-[80vh] w-full flex items-center justify-center text-center text-white">
        <Image src="https://placehold.co/1600x900.png" alt="Salon interior" layout="fill" objectFit="cover" className="absolute z-0" data-ai-hint="salon interior" />
